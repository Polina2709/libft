...
CC = ft_atoi.c ft_bzero.c ft_from_begin.c ft_isalnum.c ft_isalpha.c \
	 ft_isascii.c ft_isdigit.c ft_islower.c ft_isprint.c ft_isupper.c \
	 ft_itoa.c ft_memalloc.c ft_memccpy.c ft_memdel.c ft_memmove.c ft_memset.c \
...
OO = ft_atoi.o ft_bzero.o ft_from_begin.o ft_isalnum.o ft_isalpha.o \
	 ...
	 ft_itoa.o ft_memalloc.o ft_memccpy.o ft_memdel.o ft_memmove.o ft_memset.o \
	 ft_nbrlen.o ft_putchar.o ft_putchar_fd.o ft_putendl.o ft_putendl_fd.o \
